...
class YUVRender(private val mContext: Context) : RayRenderer {
    ...
    override fun onSurfaceCreated() {
        ...
        val fragmentShader = ShaderUtil.loadShader(mContext, "texture/fragment_shader_yuv.glsl", GLES20.GL_FRAGMENT_SHADER)
    ...
    override fun onDraw() {
        ...
        if (mWidth > 0 && mHeight > 0
            ...
            GLES20.glVertexAttribPointer(mVPosition, 2, GLES20.GL_FLOAT, false, 8, mVertextBuffer)
